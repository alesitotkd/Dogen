...
<head>
    ...
    <title>Dogen</title>
    <link rel="icon" href="./img/dogen/favicon.ico">
    <link
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-md-9 col-12">
                    <div class="toolbar-contact" style="margin-left: 10px">
                        <p>
