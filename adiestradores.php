...
<div class="container">
    <hr>
    <h5 class="card-title text-muted text-uppercase text-center">ADIESTRADORES</h5>
    <br>
    <a href="personalInsertar" class="btn btn-primary text-uppercase"
       style="background-color: #240463; border: #240463; width: 100%;">Anunciarme</a>
    <form action="adiestradores" method="post" style="margin-top: 20px">
        ...
        if (isset($_POST['filtrar']) && !empty($_POST['filtro'])){
            $resultado=infoFiltroAdiestradores($_POST['filtro']);
