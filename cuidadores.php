...
<div class="container">
    <hr>
    <h5 class="card-title text-muted text-uppercase text-center">CUIDADORES</h5>
    <br>
    ...
    <form action="cuidadores" method="post" style="margin-top: 20px">
        ...
        if (isset($_POST['filtrar'])){
            $resultado=infoFiltroCuidadores($_POST['filtro']);
